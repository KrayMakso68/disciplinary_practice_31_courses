...
#     )
#
#     role = models.PositiveSmallIntegerField('Должность', choices=ROLE_CHOICES)
#     username = models.CharField('Имя', max_length=50)
#     usersurname = models.CharField('Фамилия', max_length=50)
#     rang = models.CharField('Воинское звание', choices=RANG_CHOICES)
